package com.example.usbcamera.view;
...
import com.serenegiant.usb.widget.CameraViewInterface.Callback;
import com.example.usbcamera.MyApplication;
import com.example.usbcamera.R;
import com.example.usbcamera.bean.DeviceInfo;
import com.example.usbcamera.camera.UVCCameraHelper;
import com.example.usbcamera.util.AlertCustomDialog;
import com.example.usbcamera.util.FileUtils;
...
/**
 * Created by Zach on 2022/6/6 13:07
 */
public class USBCameraActivity extends AppCompatActivity implements CameraDialogParent, Callback {
    ...
    private com.serenegiant.usb.widget.CameraViewInterface mUVCCameraView;
    ...
    private void popCheckDevDialog() {
        ...
        AlertCustomDialog.createSimpleListDialog(this, "设备列表", dataList, new AlertCustomDialog.OnMySelectedListener() {
            @Override
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mCameraHelper = UVCCameraHelper.getInstance(1280, 720);
            ...
            case R.id.menu_takepic:
                ...
                mCameraHelper.capturePicture(picPath, new AbstractUVCCameraHandler.OnCaptureListener() {
                    ...
                    public void onCaptureResult(String path) {
                        ...
                        new Handler(USBCameraActivity.this.getMainLooper()).post(new Runnable() {
                            @Override
                            public void run() {
...
//                    FileUtils.createfile(FileUtils.ROOT_PATH + "test666.h264");
                    ...
                    com.serenegiant.usb.encoder.RecordParams params = new com.serenegiant.usb.encoder.RecordParams();
